            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                    ...
                    <a class="dropdown-item" href="{{ route('admin.logout_handler') }}"
                        onclick="event.preventDefault();document.getElementById('adminLogoutForm').submit();return false"><i
                            class="dw dw-logout"></i> Log Out</a>

                    <form id="adminLogoutForm" action="{{ route('admin.logout_handler') }}" method="POST"
                        style="display: none;">
                        @csrf
                    </form>
                </div>
        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                    ...
                    <a class="dropdown-item" href="profile.html"><i class="dw dw-settings2"></i> Setting</a>
                    <a class="dropdown-item" href="faq.html"><i class="dw dw-help"></i> Help</a>
                    <a class="dropdown-item" href="{{ route('seller.logout_handler') }}"><i class="dw dw-logout"></i>
                        Log Out</a>
                </div>
            </div>
        </div>
